...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 02 Septembre 2016 à 18:21
...
INSERT INTO `user` (`id`, `style_id`, `role_id`, `email`, `firstname`, `lastname`, `username`, `presentation`, `dispo`, `path`, `password`) VALUES
(1, NULL, 1, 'zodar', 'Tarik', 'Merabet', 'toto', 'Hello, I''m a new user of BEAT MY DJ ! :)', NULL, 'default.png', '$2y$13$LY6oQDnncSE8HTsUlH1PrORs/MehUiQrqibkjkYB/imd71NMRY4Zq'),
(2, NULL, 2, 'adminhjg', 'Oualid', 'Merabet', 'wawa', 'Hello, I''m a new user of BEAT MY DJ ! :)', NULL, 'default.png', '$2y$13$YqeOrMCdWAuwrhO.hIA8Cuh3QDlgYnxazm577L4dDMQ0.NRNbiIfu');
